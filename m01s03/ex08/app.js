...
console.warn(
  'Afiseaza propozitia “Utilizatorul cu idul iii are xxx tipuri de produse in cartul cu idul ccc.” folosind proprietatea length pe arrayul de produse',
);
console.log(
...
console.warn(
  'Afiseaza propozitia “xxx yyy cumpara ppp produse in total”; folosind accesul direct la fiecare din obiectele din arrayul products.',
);
console.log(
  cart.firstName +
    ' ' +
...
console.warn(
  'Afiseaza propozitia “Valoarea totala a cartului cu idul iii este ttt.”; folosind accesul direct la fiecare din obiectele din arrayul products (price, quantity). (product[0].price * product[0].quantity )',
);
console.log(
...
console.warn(
  'Afiseaza propozitia ”xxx yyy a cumparat produsul ppp in cantitatea ccc in valoare totala de ttt.” Foloseste produsul de pe indexul 0.',
);
console.log(
  cart.firstName +
    ' ' +
    ...
    (cart.products[0].price * cart.products[0].quantity).toString() +
    '.',
);
